...
struct BlockMmad<MmadAtlasA2FAGCube3, L1TileShape_, L0TileShape_, AType_, BType_, CType_, BiasType_, TileCopy_,
                 TileMmad_> {
  public:
    // Type Aliases
            ...
            for (uint32_t n_loop_index = 0; n_loop_index < n_loop; n_loop_index++) {
                if (n_loop_index == 0) {
                    ...
                    for (uint32_t m_loop_index = 0; m_loop_index < m_loop; m_loop_index++) {
                        ...
                        copyL1ToL0B(l0_b_ping_tensor[l0_b_buf_offset], (*l1_b_buf_tensor)[l1_b_buf_offset], layoutBInL0,
                                    layoutBInL1);
