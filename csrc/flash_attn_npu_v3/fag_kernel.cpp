...
public:
    ...
    __aicore__ inline void ComputeMM1(DBParams& dbParam)
    {
        ...
        blockMmad(dxGm[specify_for_v_aTensorOffsetCv], layoutA1,
        ...
        blockMmad(queryGm[dbParam.aTensorOffsetCv], layoutA,
...
const uint32_t IS_DROP = 0,
const DTemplateType DTEMPLATETYPE,
typename DataType = half,
const uint32_t INPUT_LAYOUT = BSND,
const uint32_t IS_DTM = 0 // 是否开启确定性计算
>
CATLASS_GLOBAL void FAG(
    uint64_t fftsAddr,
    GM_ADDR dout,
    GM_ADDR q,
    GM_ADDR k,
    ...
    using EpilogueAtlasA2SameAbVec = Catlass::Epilogue::EpilogueAtlasA2SameAbVec<INPUT_LAYOUT, IS_DROP>;
