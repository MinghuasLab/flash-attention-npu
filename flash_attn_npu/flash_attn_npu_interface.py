...
@_torch_custom_op_wrapper("flash_attn_npu_910::_flash_attn_forward", mutates_args=(), device_types="npu")
def _flash_attn_forward(
    ...
    out, softmax_lse, S_dmask, rng_state = flash_attn_npu_910.fwd(
        q,
        k,
        v,
        None,
...
@_torch_register_fake_wrapper("flash_attn_npu_910::_flash_attn_forward")
...
@_torch_custom_op_wrapper("flash_attn_npu_910::_flash_attn_varlen_forward", mutates_args=(), device_types="npu")
def _flash_attn_varlen_forward(
    ...
    q, k, v = [maybe_contiguous(x) for x in (q, k, v)]
    out, softmax_lse, S_dmask, rng_state = flash_attn_npu_910.varlen_fwd(
        q,
        k,
        v,
        None,
...
@_torch_register_fake_wrapper("flash_attn_npu_910::_flash_attn_varlen_forward")
...
@_torch_custom_op_wrapper("flash_attn_npu_910::_flash_attn_backward", mutates_args=("dq", "dk", "dv"), device_types="npu")
...
@_torch_register_fake_wrapper("flash_attn_npu_910::_flash_attn_backward")
...
@_torch_custom_op_wrapper("flash_attn_npu_910::_flash_attn_varlen_backward", mutates_args=("dq", "dk", "dv"), device_types="npu")
...
@_torch_register_fake_wrapper("flash_attn_npu_910::_flash_attn_varlen_backward")
...
def flash_attn_with_kvcache(
    ...
    out, softmax_lse = flash_attn_npu_910.fwd_kvcache(
        q,
        k_cache,
        v_cache,
        k,
