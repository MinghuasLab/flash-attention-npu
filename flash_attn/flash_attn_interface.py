...
def _flash_attn_forward(
    ...
    out, softmax_lse, S_dmask, rng_state = flash_attn_2_C.fwd(
        q,
        k,
        v,
        None,
...
def _flash_attn_varlen_forward(
    ...
    q, k, v = [maybe_contiguous(x) for x in (q, k, v)]
    out, softmax_lse, S_dmask, rng_state = flash_attn_2_C.varlen_fwd(
        q,
        k,
        v,
        None,
...
def flash_attn_with_kvcache(
    ...
    out, softmax_lse = flash_attn_2_C.fwd_kvcache(
        q,
        k_cache,
        v_cache,
        k,
